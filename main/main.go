...
func main() {
	...
	defaults := []Question{
		Question{"Path to input DNase-Seq or ATAC-Seq Bam file",
			"/labs/mpsnyder/neekonsu/2020/alphabet/ABC-Enhancer-Gene-Prediction/example_chr22/input_data/Chromatin/wgEncodeUwDnaseK562AlnRep1.chr22.bam"},
		Question{"Path to general MACS2 output directory",
			"/labs/mpsnyder/neekonsu/2020/alphabet/ABC-Enhancer-Gene-Prediction/example_chr22/ABC_output"},
		Question{"Path to ABC reference chromosome size directory",
			"/labs/mpsnyder/neekonsu/2020/alphabet/ABC-Enhancer-Gene-Prediction/example_chr22/reference"},
		Question{"Path to ABC python src directory",
			"/labs/mpsnyder/neekonsu/2020/alphabet/ABC-Enhancer-Gene-Prediction/src"},
		...
		Question{"Path to ABC-Enhancer-Gene-Prediction repository (directory)",
			"/labs/mpsnyder/neekonsu/2020/alphabet/ABC-Enhancer-Gene-Prediction"},
	}
	// Greet user
	fmt.Println("\n——————————————————————————————————————————————")
